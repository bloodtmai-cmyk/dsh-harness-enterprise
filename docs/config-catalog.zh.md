...
export interface Config {
  ...
  dshHome?: string
  /** Trusted enterprise AGENTS.md assembled as a mandatory system instruction; empty disables it. */
  managedInstructionFile?: string
  /** Read-only SHA-256 sidecar refreshed with the managed file; required when the file is configured. */
...
export interface Config {
   ...
   */
  maxParallelToolCalls?: number
  /** Maximum model/tool steps admitted by one turn. Deployment policy, not a user setting. */
  maxStepsPerTurn?: number
  /** Maximum provider attempts admitted by one step, including its initial request. */
  maxRequestAttemptsPerStep?: number
  /** Maximum cumulative reported input, output, and cache tokens admitted by one turn. */
...
export interface Config {
  ...
  default: string
  /** Allow the settings document to override `default`. Defaults to true. */
...
export interface Config {
  ...
  /** Agent-loop deployment cap for model/tool steps in one turn. */
  maxStepsPerTurn?: AgentLoopConfig['maxStepsPerTurn']
  /** Agent-loop deployment cap for provider attempts in one step. */
  maxRequestAttemptsPerStep?: AgentLoopConfig['maxRequestAttemptsPerStep']
  /** Agent-loop deployment cap for cumulative reported usage in one turn. */
...
来源：[`packages/attachment/attachment-local/src/index.ts:44`](../packages/attachment/attachment-local/src/index.ts)
...
export interface Config {
  ...
  nativeOpen?: boolean
  /**
   * Whether clients may prepare and open the provider-owned settings file.
   * Disable this for managed products whose deployment configuration is not
   * an end-user editing surface.
   */
  settingsDocumentOpen?: boolean
  /** Settings namespaces clients may read and write; undefined exposes all registered namespaces. */
  settingsNamespaceAllowlist?: string[]
  /**
...
export interface Config {
  ...
  port: number
  /** Optional environment variable containing a bearer token required for every HTTP and upgrade request. */
...
<a id="deepseek-aidsh-llm-openai-compatible-managed"></a>
...
来源：[`packages/llm/llm-openai-compatible-managed/src/index.ts:25`](../packages/llm/llm-openai-compatible-managed/src/index.ts)
...
export interface StdioConfig {
  ...
  /** Deployment-owned guidance appended to every model-facing tool description. */
  toolGuidance?: string
  /** Include the opaque Harness session id in trusted Gateway calls. */
  includeSessionMeta?: boolean
  /** Poll tools/list when a managed Gateway cannot emit list-changed notifications; zero disables polling. */
  toolRefreshIntervalMs?: number
  /** JSON envelope error codes that a non-conformant MCP server returned as success. */
  jsonErrorMessages?: Record<string, string>
...
export interface StreamableHttpConfig {
  ...
  headers: Record<string, string>
  /** Optional loopback broker that supplies a short-lived Bearer token per request. */
  bearerTokenBroker?: {
    /** Loopback HTTP endpoint owned by the desktop host. */
    url: string
    /** Per-process secret used to authenticate to the loopback broker. */
    secret: string
  }
  /** Per-tool-call timeout in milliseconds. */
  toolCallTimeoutMs: number
...
来源：[`packages/mcp/mcp-client/src/index.ts:121`](../packages/mcp/mcp-client/src/index.ts)
...
来源：[`packages/memory/personal-memory-local/src/index.ts:57`](../packages/memory/personal-memory-local/src/index.ts)
...
<a id="deepseek-aidsh-session-audit-ai-hub"></a>

## `@deepseek-ai/dsh-session-audit-ai-hub`
...
来源：[`packages/session/session-audit-ai-hub/src/index.ts:12`](../packages/session/session-audit-ai-hub/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-settings-ai-hub`（[`packages/client/ui-settings-ai-hub/src/index.ts`](../packages/client/ui-settings-ai-hub/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-settings-general`（[`packages/client/ui-settings-general/src/index.ts`](../packages/client/ui-settings-general/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-settings-models`（[`packages/client/ui-settings-models/src/index.ts`](../packages/client/ui-settings-models/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-settings-personal-memory`（[`packages/client/ui-settings-personal-memory/src/index.ts`](../packages/client/ui-settings-personal-memory/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-settings-plugin-inventory`（[`packages/client/ui-settings-plugin-inventory/src/index.ts`](../packages/client/ui-settings-plugin-inventory/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-settings-plugins`（[`packages/client/ui-settings-plugins/src/index.ts`](../packages/client/ui-settings-plugins/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-sidebar`（[`packages/client/ui-sidebar/src/index.ts`](../packages/client/ui-sidebar/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-skill`（[`packages/client/ui-skill/src/index.ts`](../packages/client/ui-skill/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-stream-activity`（[`packages/client/ui-stream-activity/src/index.ts`](../packages/client/ui-stream-activity/src/index.ts)）
...
- `@deepseek-ai/dsh-host-ai-hub-catalog`（[`packages/host/ai-hub-catalog/src/index.ts`](../packages/host/ai-hub-catalog/src/index.ts)）
