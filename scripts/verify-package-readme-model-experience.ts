...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-stream-activity': { kind: 'none', reason: 'Browser-side presentation plug-in; changes only CSS over stable conversation and Tool data attributes.' },
  ...
  'packages/client/ui-settings-ai-hub': { kind: 'none', reason: 'Browser-side authorization catalog projection; registers nothing model-facing.' },
  ...
  'packages/host/ai-hub-catalog': { kind: 'none', reason: 'Host-side read-only AI Hub catalog projection; registers nothing model-facing.' },
  ...
  'packages/session/session-audit-ai-hub': { kind: 'none', reason: 'The observer uploads completed-turn audit records without changing model input or the Session log.' },
