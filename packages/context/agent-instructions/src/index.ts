...
import { registerManagedInstruction } from './managed.ts'
...
export {
  createManagedInstructionReader,
  loadManagedInstructionFile,
  loadManagedInstructionHashFile,
  MANAGED_INSTRUCTION_ORDER,
  MANAGED_INSTRUCTION_SECTION,
  renderManagedInstructionPrompt,
} from './managed.ts'
...
export function apply(ctx: Context, config: Config): void {
  ...
  registerManagedInstruction(
    ctx,
    resolved.managedInstructionFile,
    resolved.managedInstructionHashFile,
