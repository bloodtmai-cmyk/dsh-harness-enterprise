...
export const Config: z<Config> = z.object({
  dshHome: z.string(),
  managedInstructionFile: z.string().default(''),
  managedInstructionHashFile: z.string().default(''),
...
export function resolveConfig(config: Config): ResolvedConfig {
  return {
    ...
    ...config.managedInstructionFile?.trim()
      ? { managedInstructionFile: config.managedInstructionFile.trim() }
      : {},
    ...config.managedInstructionHashFile?.trim()
      ? { managedInstructionHashFile: config.managedInstructionHashFile.trim() }
      : {},
  }
}
