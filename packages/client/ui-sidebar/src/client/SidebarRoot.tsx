 ...
 * and the foot holds `sidebar.settings`, its compact adjacent actions, and
...
export function SidebarRoot({
  ...
  return (
    ...
    >
      ...
      {/* Destinations stack above Settings. Compact status actions share the
          Settings row when wide and move immediately above it in the rail. */}
