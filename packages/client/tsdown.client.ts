...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    outputOptions: {
      ...
      // The browser loader fetches one closure-factory artifact per plugin and
      // has no URL/module-table contract for secondary chunks. Keep dynamic
      // imports lazy at source level while folding their code into client.js.
      codeSplitting: false,
