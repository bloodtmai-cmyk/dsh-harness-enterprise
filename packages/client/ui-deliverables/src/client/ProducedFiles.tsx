...
import { basename, parentDirectory } from './turn-deliverables.ts'
...
export function ProducedFiles({
  ...
  return (
    <div className={css.root}>
      ...
      {canOpenPath && (
        <button type="button" className={css.showFolder} onClick={() => { openFile(parentDirectory(paths[0] ?? '.')) }}>
