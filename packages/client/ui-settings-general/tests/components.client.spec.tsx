...
describe('AboutSection', () => {
  it('shows the desktop product name and installed application version', () => {
    render(<AboutSection
      info={{ productName: 'Harness Enterprise Desktop', version: '0.1.0-rc.24' }}
      t={t}
    />)
    expect(screen.getByRole('heading', { name: 'Harness Enterprise Desktop' })).toBeTruthy()
    expect(screen.getByText('Version')).toBeTruthy()
    expect(screen.getByText('0.1.0-rc.24')).toBeTruthy()
  })
})
