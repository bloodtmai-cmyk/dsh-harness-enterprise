...
import {
  ...
  IconPersonalizationOutline16, IconQuestionOutline14, IconSettingsOutline16, IconUserOutline16,
...
function navIcon(id: string) {
  if (id === 'personal') return <IconUserOutline16 className={css.navIcon} size={16} />
