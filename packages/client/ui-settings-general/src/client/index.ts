...
import type { AboutSectionInjected, DesktopAppInfo } from './AboutSection.tsx'
...
export type { AboutSectionInjected, AboutSectionProps, DesktopAppInfo } from './AboutSection.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const desktopAppInfo = typeof window === 'undefined' ? undefined : window.desktopAppInfo
  ...
  if (desktopAppInfo !== undefined) {
    ctx.slots.inject('settings.section', () => ctx.slots.register({
      ...
      label: () => t('about.nav'),
      locale: NS,
      inject: (): AboutSectionInjected => ({ info: desktopAppInfo, t }),
    }, AboutSection))
  }
}
