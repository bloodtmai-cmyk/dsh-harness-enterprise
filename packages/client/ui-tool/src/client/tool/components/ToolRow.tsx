...
import { searchBlockLabels, webBlockLabels } from '../models/card-labels.ts'
...
import { GptVisChart } from './GptVisChart.tsx'
...
export interface ToolRowProps {
  ...
  /** Rich chart returned alongside the model-visible text result. */
  chart?: Extract<ToolResultNode['content'][number], { type: 'chart' }> | undefined
  state: ToolRowState
  /**
...
export function ToolRow({
  ...
  useEffect(() => {
    if (chart !== undefined) setExpanded(true)
  }, [chart])
  ...
  const expandable = body !== null || outputText !== null || card !== null || chart !== undefined
                  ...
                  : webBody !== null
                    ...
                    : (
                      <>
                        ...
                        {chart !== undefined ? <GptVisChart chart={chart} t={t} /> : null}
