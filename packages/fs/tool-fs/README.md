...
| `deliver_files` | `paths` | Registers 1–12 existing regular files inside the session workspace as user-facing outputs. It reads no file contents and rejects missing, directory, or workspace-escaping paths. |
