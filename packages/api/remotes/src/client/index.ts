...
import aiHubCatalogRemote from '@deepseek-ai/dsh-host-ai-hub-catalog/remote'
...
export type {
  AiHubBundleCatalogItem,
  AiHubCapabilityType,
  AiHubCapabilityView,
  AiHubCatalogSnapshot,
  AiHubMcpCatalogItem,
  AiHubMarketItem,
  AiHubMarketSnapshot,
  AiHubMarketState,
  AiHubMenuEntitlements,
  AiHubMenuKey,
} from '@deepseek-ai/dsh-host-ai-hub-catalog/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-ai-hub-catalog/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, aiHubCatalogRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
