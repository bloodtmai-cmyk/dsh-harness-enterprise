...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  static Config: z<Config> = z.object({
    ...
    settingsDocumentOpen: z.boolean(),
    settingsNamespaceAllowlist: z.array(z.string()).default(undefined as unknown as string[]),
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const api = createApiProxy(ctx, {
      ...
      ...config.settingsDocumentOpen === undefined
        ? {}
        : { settingsDocumentOpen: config.settingsDocumentOpen },
      ...config.settingsNamespaceAllowlist === undefined
        ? {}
        : { settingsNamespaceAllowlist: config.settingsNamespaceAllowlist },
