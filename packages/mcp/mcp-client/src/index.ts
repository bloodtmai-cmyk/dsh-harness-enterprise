...
export const Config = z.union([
  z.object({
    ...
    includeSessionMeta: z.boolean().default(false),
    toolRefreshIntervalMs: z.number().min(0).max(MAX_TIMER_DELAY_MS).default(0),
    jsonErrorMessages: z.dict(String).default({}),
    reconnect: Reconnect,
  }),
  z.object({
